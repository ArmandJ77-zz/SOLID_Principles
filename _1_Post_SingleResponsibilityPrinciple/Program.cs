...
namespace _1_Post_SingleResponsibilityPrinciple
{
    ...
    {
        /// <summary>
        /// 1) this class has no concrn over the shape classes as they have been moved to their own files
        ...
        /// 5) the Program class's primary concurn is to properties of the shapes
        /// </summary>
